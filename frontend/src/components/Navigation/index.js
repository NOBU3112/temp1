...
import { NavLink, useHistory } from "react-router-dom"; // Sử dụng useHistory thay vì useNavigate
import { useSelector } from "react-redux";
import ProfileButton from "./ProfileButton";
import LoginFormModal from "../LoginFormModal";
import SignupFormModal from "../SignupFormModal";
import { FaCrown } from "react-icons/fa"; // Import icon VIP
...
function Navigation({ isLoaded }) {
  ...
  const history = useHistory(); // Dùng hook useHistory thay cho useNavigate
